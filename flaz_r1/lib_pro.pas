...
uses
  ...
  ExtCtrls, Ipfilebroker, FileUtil, LazFileUtils,Windows, FTPsend;
...
//ftp получение перечня имен файлов
function FtpGetDir(const IP, Port, Path, User, Pass: string; DirList: TListBox): Boolean;
implementation
